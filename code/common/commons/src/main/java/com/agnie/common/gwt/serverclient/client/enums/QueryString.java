...
public enum QueryString {
    SOURCE("source"), SESSION("sessionid"), GWT_DEV_MODE("gwt.codesvr"), LOCALE("locale"), QUESTION_MARK("?"), AMPERSAND("&"), HASH("#"), USER_NAME("user"), DOMAIN("domain"), SELECTED_DOMAIN(
            "sel-domain"), HISTORY_HASH("history-token"), SELECTED_CONTEXT(
                    "sel-context"), CONTEXT("context"), API_ACCESS_KEY("access-key"), REFERER("Referer"), HEADER_AUTH_IDENTIFIER("auth_identifier"), HEADER_AUTH_KEY("auth_key");
